...
mean_C= statistics.mean(mean_sq_er_list)
standard_deviation_C = statistics.stdev(mean_sq_er_list)

mean_B = 290.56716899224227

mean_difference = mean_B - mean_C
# this is the differene in the mean for part A and part B 
mean_difference=13.587708683958567

mean_C=276.97946030828371

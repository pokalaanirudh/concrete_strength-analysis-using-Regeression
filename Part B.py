...
mean_B= statistics.mean(mean_sq_er_list)

standard_deviation_B = statistics.stdev(mean_sq_er_list)

mean_A = 273.18725491088185
mean_difference = mean_B - mean_A
mean_difference= 17.379914081360425

standard_deviation_B=40.30688302676195
